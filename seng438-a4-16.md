...
To improve mutation score, we can add test cases for methods which have never been tested. This technique is sure to improve mutation score drastically. Afterwards, we can improve our test cases to catch more intricate mutations which end up surviving.
